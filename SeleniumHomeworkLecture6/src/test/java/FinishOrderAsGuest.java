...
public class FinishOrderAsGuest {
    ...
    public void placeOrderAsGuestTest() {
        ...
        driver.findElement(By.id("input-payment-firstname")).sendKeys("Bilyana");
        driver.findElement(By.id("input-payment-lastname")).sendKeys("Gospodinova");
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("button-shipping-method"))).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.name("agree"))).click();
        driver.findElement(By.id("button-payment-method")).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("button-confirm"))).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h1[text()='Your order has been placed!']")));
        WebElement orderConfirmation = driver.findElement(By.xpath("//h1[text()='Your order has been placed!']"));
        Assert.assertEquals(orderConfirmation.getText(), "Your order has been placed!");
    }
